...
const { loginValidation, createPasswordValidation,forgotPasswordValidation,resetPasswordValidation } = require("../validations/auth.validation",);
const { login, createPassword, getCurrentUser,forgotPassword, resetPassword } = require("../controllers/auth.controller",);
