...
const { getPendingEmployees, updateDoctorAvailability,

    getDoctorAvailability, approveEmployee, rejectEmployee, } = require("../controllers/employee.controller",);
...
router.patch("/:id/deactivate", authMiddleware, roleMiddleware("ADMIN"), deactivateEmployee,);
...
router.patch("/:id/activate", authMiddleware, roleMiddleware("ADMIN"), activateEmployee);
